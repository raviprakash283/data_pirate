...
function pathfinding() {
	...
	if (selectedAlgo == 1) { algo = 'Dijkstra'; path = Dijkstra(array, start_i, start_j, end_i, end_j); }
	if (selectedAlgo == 2) { algo = 'Breadth Fist Search'; path = BFS(array, start_i, start_j, end_i, end_j); }
	if (selectedAlgo == 3) { algo = 'Depth Fist Search'; path = DFS(array, start_i, start_j, end_i, end_j); alert("Kindly note that this may not be the shortest path"); }
